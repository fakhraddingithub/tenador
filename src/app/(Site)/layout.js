...
export const metadata = {
  ...
  title: {
    default: "تنادور | فروشگاه تخصصی تنیس و پدل",
    template: "%s | تنادور",
  },

  description:
    "تنادور فروشگاه تخصصی لوازم تنیس و پدل؛ خرید انواع راکت، کفش، پوشاک و تجهیزات حرفه‌ای از برندهای معتبر جهانی با ضمانت اصالت و ارسال سریع.",
  ...
  openGraph: {
    ...
    title: "تنادور | فروشگاه تخصصی تنیس و پدل",
...
export default async function RootLayout({ children }) {
  ...
  const jsonLd = {
    ...
    description:
      "فروشگاه تخصصی لوازم تنیس و پدل",
