  ...
  const handleAddOrUpdateTabItem = () => {
    ...
    if (editingTabItemIndex !== null) {
      setCustomTabItems((prev) =>
        prev.map((it, i) => (i === editingTabItemIndex ? { ...currentTabItem } : it))
      );
            ...
            <div className="border-t pt-8 space-y-6">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-neutral-500">
                    مثل «تکنولوژی‌ها» برای راکت تنیس؛ فقط برای محصولاتی نمایش داده می‌شود که آیتم مرتبط دارند.
                  </p>
                </div>
