        ...
        <div className="relative flex flex-col md:flex-row md:items-end justify-between mb-20">
          ...
          <div className="flex items-center mt-8 md:mt-0">
            <div className="flex bg-white/80 backdrop-blur-md shadow-2xl shadow-black/5 rounded-[16px] p-1.5 border border-white/50">
              <button className="product-prev-btn-2 w-14 h-14 flex items-center justify-center text-gray-400 hover:text-[#aa4725] hover:bg-[#aa4725]/5 transition-all duration-300 rounded-[12px]">
                <FiArrowRight size={26} />
              </button>
              <div className="w-[1px] h-8 bg-gray-100 self-center mx-1"></div>
              <button className="product-next-btn-2 w-14 h-14 flex items-center justify-center text-gray-400 hover:text-[#aa4725] hover:bg-[#aa4725]/5 transition-all duration-300 rounded-[12px]">
                <FiArrowLeft size={26} />
              </button>
            </div>
          </div>
