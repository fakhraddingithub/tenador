 ...
 * PushOptInBanner
 *
 * بنرِ غیرمزاحمِ درخواستِ اجازهٔ نوتیفیکیشن — سراسریِ سایت (وضعیت سفارش،
 * محصولات دست دوم جدید و مواردِ مشابه).
 *
 * رفتار (مطابق Step 5):
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <h3 className="mb-1 text-sm font-bold text-[var(--color-text)]">
            از سفارش‌ها و پیشنهادهای تنادور باخبر شو
          </h3>
          <p className="text-xs leading-relaxed text-gray-500">
            با فعال‌کردن نوتیفیکیشن، از وضعیت سفارش‌هایت، محصولات دست دوم جدید و پیشنهادهای ویژه باخبر می‌شوی.
          </p>
        </div>
      </div>
