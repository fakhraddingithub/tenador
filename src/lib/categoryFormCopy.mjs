 ...
 *   - «بارگذاری»   → همه‌ی ورزش‌ها، با نامِ ورزش بعد از نامِ دسته‌های اختصاصی؛
 *                    دسته‌های مشترک فقط نام خود دسته را نشان می‌دهند.
 */
 ...
 * سپس عنوان، با برچسبِ یکسان با سایر قسمت‌های پنل.
 */
