    ...
    modules: [
      {
        ...
        permissions: [
          ...
          // حذفِ دائمی و برگشت‌ناپذیرِ سفارش به‌همراهِ پرداخت‌هایش. عمداً کلیدِ
          // جداست و زیرِ changeStatus/editItems نرفت: «لغو سفارش» یک وضعیت است
          // و برگشت‌پذیر، این یکی داده را برای همیشه می‌برد. با افزوده‌شدنِ این
          // کلید هیچ نقشِ فعلی آن را نمی‌گیرد (فقط دسترسیِ کامل) — یعنی قابلیتِ
          // جدید به‌صورت پیش‌فرض بسته است، که برای یک عملیاتِ مخرب درست است.
          { key: "delete", title: "حذف دائمی سفارش" },
        ],
      },
      {
        key: "orderTracking",
...
export const ADMIN_ROUTE_PERMISSIONS = {
  ...
  "/p-admin/admin-brands/[brandId]/brochure/preview": ["brands.edit"],
  "/p-admin/admin-brands/[brandId]/category-article/[categoryId]": ["brands.edit"],
  "/p-admin/admin-brands/[brandId]/category-article/[categoryId]/preview": ["brands.edit"],
  "/p-admin/admin-brands/[brandId]/[serieId]/mini-article": ["series.edit"],
  "/p-admin/admin-brands/[brandId]/[serieId]/mini-article/preview": ["series.edit"],
